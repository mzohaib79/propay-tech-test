<div class="btn-group">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference{{ $user->id }}" style="will-change: transform;">
        <a class="dropdown-item editUser" href="javascript:void(0)" data-url="{{ route('user.edit', $user->id) }}">Edit</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item deleteUser" href="javascript:void(0)" data-url="{{ route('user.delete', $user->id) }}">Delete</a>
    </div>
</div>
